...
void PlaceShipController::addShip(cpp_warships::input_parser::ParsedOptions options) {
    Direction direct =
...
void PlaceShipController::removeShip(cpp_warships::input_parser::ParsedOptions options) {
    std::pair<int, int> coordinate = TypesHelper::cell(options["cell"]);
