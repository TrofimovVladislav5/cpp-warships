...
#include "game_states/OngoingGameState.h"
#include "ongoing_game_substates/BattleOngoingGameSubState.h"
#include "ongoing_game_substates/InitiateOngoingGameSubState.h"
#include "ongoing_game_substates/NewMatchSettingsSubState.h"
...
namespace cpp_warships::application {
    ...
    MatchBuilder::MatchBuilder(input_reader::InputReader<>* reader)
        : isLoaded(false), isLoadedFromTemplate(false), currentData(nullptr), reader(reader) {}
