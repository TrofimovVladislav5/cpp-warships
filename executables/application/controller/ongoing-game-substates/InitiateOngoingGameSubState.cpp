#include "../../model/exceptions/ShipPlacementException.h"
...
void InitiateOngoingGameSubState::handleShipsShuffle(cpp_warships::input_parser::ParsedOptions options) {
    playerPlaceController->placeShipsRandomly();
}

void InitiateOngoingGameSubState::handleConfirm(cpp_warships::input_parser::ParsedOptions options) {
...
void InitiateOngoingGameSubState::handlePause(cpp_warships::input_parser::ParsedOptions options) {
    latestCommand = "pause";
}
    ...
    , confirmed(false)
{
    ...
    this->inputScheme = {
        {"shuffle", cpp_warships::input_parser::ParserCommandInfo(
            commandBuilder
        ...
        {"add", cpp_warships::input_parser::ParserCommandInfo(
            commandBuilder
        ...
        {"remove", cpp_warships::input_parser::ParserCommandInfo(
            commandBuilder
...
void InitiateOngoingGameSubState::updateSubState() {
    ...
    cpp_warships::input_parser::VoidParser parser(inputScheme, cpp_warships::input_parser::DefaultParserError::CommandNotFoundError);
