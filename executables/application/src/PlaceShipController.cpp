...
#include "../include/state_machine/substates/SubStateContext.h"
...
namespace cpp_warships::application {
    ...
    void PlaceShipController::addShip(input_parser::ParsedOptions options) {
        Direction direct =
    ...
    void PlaceShipController::removeShip(input_parser::ParsedOptions options) {
        std::pair<int, int> coordinate = TypesHelper::cell(options["cell"]);
