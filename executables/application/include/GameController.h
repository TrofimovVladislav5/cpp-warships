...
#include "state_machine/GameState.h"
#include "state_machine/states/MenuGameState.h"
...
namespace cpp_warships::application {
    ...
    private:
        template <class U>
        static std::true_type test(const input_reader::InputReader<U> *);
    ...
    public:
        explicit GameController(T *inputReader = new input_reader::console_reader::ConsoleInputReader())
